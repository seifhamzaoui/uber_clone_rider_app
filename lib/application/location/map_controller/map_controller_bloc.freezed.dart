...
abstract class $MapControllerStateCopyWith<$Res> {
  ...
  $Res call({GoogleMapController? mapController, LatLng? currentposition});
}
...
/// @nodoc
abstract class _$$_MapControllerStateCopyWith<$Res>
    implements $MapControllerStateCopyWith<$Res> {
  factory _$$_MapControllerStateCopyWith(_$_MapControllerState value,
          $Res Function(_$_MapControllerState) then) =
      __$$_MapControllerStateCopyWithImpl<$Res>;
  @override
  $Res call({GoogleMapController? mapController, LatLng? currentposition});
}

/// @nodoc
class __$$_MapControllerStateCopyWithImpl<$Res>
    extends _$MapControllerStateCopyWithImpl<$Res>
    implements _$$_MapControllerStateCopyWith<$Res> {
  __$$_MapControllerStateCopyWithImpl(
      _$_MapControllerState _value, $Res Function(_$_MapControllerState) _then)
      : super(_value, (v) => _then(v as _$_MapControllerState));

  @override
  _$_MapControllerState get _value => super._value as _$_MapControllerState;
  ...
  $Res call({
    ...
    return _then(_$_MapControllerState(
      mapController: mapController == freezed
          ? _value.mapController
          : mapController // ignore: cast_nullable_to_non_nullable
              as GoogleMapController?,
...
class _$_MapControllerState implements _MapControllerState {
  const _$_MapControllerState({this.mapController, this.currentposition});
  ...
  @override
  String toString() {
    return 'MapControllerState(mapController: $mapController, currentposition: $currentposition)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$_MapControllerState &&
            const DeepCollectionEquality()
                .equals(other.mapController, mapController) &&
            const DeepCollectionEquality()
  ...
  @JsonKey(ignore: true)
  @override
  _$$_MapControllerStateCopyWith<_$_MapControllerState> get copyWith =>
      __$$_MapControllerStateCopyWithImpl<_$_MapControllerState>(
          this, _$identity);
}
...
abstract class _MapControllerState implements MapControllerState {
  const factory _MapControllerState(
      {final GoogleMapController? mapController,
      final LatLng? currentposition}) = _$_MapControllerState;
